export const idlFactory = ({ IDL }) => {
  ...
  const CanisterSettings = IDL.Record({
    ...
    'snapshot_visibility' : IDL.Opt(LogVisibility),
    'wasm_memory_limit' : IDL.Opt(IDL.Nat),
    'status_visibility' : IDL.Opt(LogVisibility),
  ...
  const Result_11 = IDL.Variant({ 'Ok' : ReleaseReceipt, 'Err' : IDL.Text });
  ...
  const Result_13 = IDL.Variant({ 'Ok' : ProvisionReceipt, 'Err' : IDL.Text });
  ...
  const Result_16 = IDL.Variant({ 'Ok' : WasmMetadata, 'Err' : IDL.Text });
  ...
  const Result_17 = IDL.Variant({ 'Ok' : StateInfo, 'Err' : IDL.Text });
  ...
  const Result_18 = IDL.Variant({ 'Ok' : WasmInfo, 'Err' : IDL.Text });
  const Result_19 = IDL.Variant({ 'Ok' : IDL.Vec(IDL.Nat8), 'Err' : IDL.Text });
  const Result_20 = IDL.Variant({
    'Ok' : IDL.Vec(ProvisionReceipt),
    'Err' : IDL.Text,
  });
  const ScanPage_1 = IDL.Record({
    'next_cursor' : IDL.Opt(IDL.Vec(IDL.Nat8)),
    'items' : IDL.Vec(ProvisionReceipt),
  });
  const Result_21 = IDL.Variant({ 'Ok' : ScanPage_1, 'Err' : IDL.Text });
  ...
  return IDL.Service({
    ...
    'admin_archive_completed_requests_page' : IDL.Func(
        [IDL.Nat64, IDL.Opt(IDL.Vec(IDL.Nat8)), IDL.Nat32],
        [Result_4],
        [],
      ),
    ...
    'admin_batch_topup' : IDL.Func([], [Result_7], []),
    'admin_batch_topup_page' : IDL.Func(
        [IDL.Opt(IDL.Principal), IDL.Opt(IDL.Nat32)],
        [Result_8],
        [],
      ),
    'admin_batch_topup_v2' : IDL.Func([], [Result_8], []),
    ...
    'admin_refill_pool' : IDL.Func([IDL.Text], [Result_9], []),
    ...
    'ensure_deployment' : IDL.Func([DeploymentRequest], [Result_13], []),
    'ensure_install' : IDL.Func([InstallRequest], [Result_13], []),
    'get_canister_status' : IDL.Func([IDL.Opt(IDL.Principal)], [Result_14], []),
    'get_deployed_canisters' : IDL.Func([], [Result_15], ['query']),
    'get_deployed_canisters_info' : IDL.Func([], [Result_12], ['query']),
    ...
    'get_state' : IDL.Func([], [Result_17], ['query']),
    'get_wasm' : IDL.Func([IDL.Vec(IDL.Nat8)], [Result_18], ['query']),
    'get_wasm_chunk' : IDL.Func(
        [IDL.Vec(IDL.Nat8), IDL.Nat64, IDL.Nat32],
        [Result_19],
        ['query'],
      ),
    'get_wasm_metadata' : IDL.Func([IDL.Vec(IDL.Nat8)], [Result_16], ['query']),
    'list_expired_reservations' : IDL.Func(
        [IDL.Opt(IDL.Vec(IDL.Nat8)), IDL.Opt(IDL.Nat32)],
        [Result_20],
        ['query'],
      ),
    'list_expired_reservations_page' : IDL.Func(
        [IDL.Opt(IDL.Vec(IDL.Nat8)), IDL.Nat32],
        [Result_21],
        ['query'],
      ),
    ...
    'list_provision_templates' : IDL.Func([], [Result_24], ['query']),
    ...
    'reserve_canister' : IDL.Func([ReserveRequest], [Result_25], []),
    ...
    'validate_admin_batch_topup' : IDL.Func([], [Result_26], []),
